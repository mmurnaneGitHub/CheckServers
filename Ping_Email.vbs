...
objCDO1.Textbody = "Please review CED Web Apps Server Report below. If errors are present: forward this email to Jimmie Farmer & run the Checks below." & vbCrLf & vbCrLf _
...
objCDO1.Subject = "CED Web Apps Server Report"
